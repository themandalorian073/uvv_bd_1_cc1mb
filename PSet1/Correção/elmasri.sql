...
/* banco de dados "uvv", se ele existir, e o usuário "abrantes", se ele        */
...
/* usuário "abrantes" e o banco de dados "uvv".                                */
/* --------------------------------------------------------------------------- */

-- Cria o usuário "abrantes", que será o dono do banco de dados "uvv". Por
...
-- colocar o usuário "abrantes" como o dono desse banco de dados. Além disso
...
/* usuário "abrantes" e criaremos o schema "elmasri". Também ajustaremos o     */
/* SEARCH_PATH do usuário para manter o scheme "elmasri" como o padrão.        */
/* --------------------------------------------------------------------------- */

-- Conexão ao banco "uvv" como usuário "abrantes", passando a senha via string
...
COMMENT ON COLUMN departamento.numero_departamento IS 'Número do departamento, PK desta tabela.';
COMMENT ON COLUMN departamento.nome_departamento   IS 'Nome do departamento. Deve ser único.';
COMMENT ON COLUMN departamento.cpf_gerente         IS 'CPF do gerente do departamento, FK para a tabela funcionários.';
...
COMMENT ON COLUMN projeto.numero_projeto      IS 'Número do projeto, PK desta tabela.';
